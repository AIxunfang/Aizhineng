              ...
              <el-form :inline="true" :model="modelparameter"  ref="modelparameter"  class="modelfrom" label-width="130px" :rules="modelrules">
                     <div>
                        ...
                        <el-form-item prop="radio3">
                            ...
                            <span v-if="modelparameter.radio3==1">CPU:{{projectcpu}}GPU:{{projectgpu}}内存:{{projectmemory}}</span>
                            <span v-if="modelparameter.radio3==2">GPU:{{projectgpu}}内存:{{projectmemory}}</span>                               
                        </el-form-item>
        ...
        methods:{
           ...
           creatmodel(){//创建模块
                  ...
                  var parms={  
                                      ...
                                      trainingParamShell: this.trainingParamShell,
