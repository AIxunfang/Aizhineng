      ...
      <el-col :span='24'>
         ...
         <el-col :span="24">
             <div class="selectmodelform">
                <el-form :inline="true" :model="mdoelform" size='small'  label-width='100px'    class="addmodelforminline"  ref="mdoelform"  :rules="rules">
                     <div>
                        <el-form-item label="发布名称" prop="publishName" >
                             <el-input v-model="mdoelform.publishName"></el-input>
                        </el-form-item>
                        <el-form-item label="  镜像名称" prop='publishImage'>
                   ...
                   <div>
                    ...
                    <div>
                         ...
                         <el-form-item>
                             <el-button size="mini" type="primary" @click="analysis()">解析参数</el-button>
                         </el-form-item>
