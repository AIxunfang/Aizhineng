...
axios.interceptors.request.use(function (config) {
    ...
    if (config.method === 'post') {
        ...
        if (config.url === "/publish/create/model" || config.url === "/common/delete"||
             config.url === "/hdfs/delete"|| config.url === "/hdfs/download"|| config.url === '/common/move'||
             config.url === "/hdfs/mv" 
        ) {
            let data = config.data
            config.headers = { 'Content-type': 'application/json;charset=UTF-8' };
...
//训练模型-->启动
export const publishrestart = (parms) => {
    return axios
        .get('/publish/restart', { params: parms })
}
//训练成功后的下载
export const modeldownload = (parms) => {
    return axios
        .get('/training/model/download', { params: parms })
}
...
//项目分享下载
export const projectSharedownload = (parms) => {
    return axios
        .get('/projectShare/zip', { params: parms })
}
...
//视频资源查询
export const videoResourcelist = (parms) => {
    return axios
        .get('/course/videoResource/list', { params: parms })
}
//视频资源分页查询
export const videoResourcepage = (parms) => {
    return axios
        .get('/course/videoResource/page', { params: parms })
}
//删除单个视频的资源
export const delectvideoResource = (parms) => {
    return axios
        .get('/course/delete/videoResource', { params: parms })
}
//编辑视频
export const updatevideoResource = (parms) => {
    return axios
        .post('/course/update/videoResource', parms)
}
//删除课程体系
...
//新增资料的
export const addcourseMaterial = (parms) => {
    return axios
...
//下载课资料
export const findcourseMaterial = (parms) => {
    return axios
        .get('/course/find/courseMaterial', { params: parms })
}
//文件上传
export const hdfsupload = (parms) => {
    return axios
        .post('/hdfs/upload', parms)
}
//hdfs列表
export const hdfslist = (parms) => {
    return axios
        .get('/hdfs/list', { params: parms })
}
//文件删除
export const hdfsdelete = (parms) => {
    return axios
        .post('/hdfs/delete', parms)
}
//从hdfs下载
export const hdfsdown = (parms) => {
    return axios
        .post('/hdfs/download',  parms )
}
//创建文件夹
export const hdfscreate = (parms) => {
    return axios
        .get('/hdfs/create', { params: parms })
}
//重命名文件夹
export const hefsrename = (parms) => {
    return axios
        .get('/hdfs/rename', { params: parms })
}
//移动文件
export const hefsmove = (parms) => {
    return axios
        .post('/hdfs/mv',  parms )
}
//获取通知
export const notifynumber = (parms) => {
    return axios
        .get('/index/notify/number', { params: parms })
}
//通知条数分页获取
export const indexnotifys = (parms) => {
    return axios
        .get('/index/notifys', { params: parms })
}
//通知状态更新
export const notifyupdate = (parms) => {
    return axios
        .get('/index/notify/update', { params: parms })
}
//通知消息删除
export const notifydelect = (parms) => {
    return axios
        .get('/index/notify/delete', { params: parms })
}
//显示
export const announcementweb = (parms) => {
    return axios
        .get('/index/announcement/web', { params: parms })
}
//更该公告
export const announcementupdate = (parms) => {
    return axios
        .get('/index/announcement/update', { params: parms })
}
//个人修改密码
...
//文件管理-->列表
export const commonlist = (parms) => {
    return axios
        .get('/common/list', { params: parms })
}
//文件管理创建目录
export const commoncreat = (parms) => {
    return axios
        .get('/common/create', { params: parms })
}
//文件管理重命名文件夹
export const commonrename = (parms) => {
    return axios
        .get('/common/rename', { params: parms })
}
//文件或者文件夹删除
export const commondelete = (parms) => {
    return axios
        .post('/common/delete', parms)
}
//文件下载
export const commondownload = (parms) => {
    return axios
        .post('/common/download',  parms )
}
//文件移动
export const commondownmove = (parms) => {
    return axios
        .post('/common/move',  parms )
}
//文件解压
export const commonunzip = (parms) => {
    return axios
        .get('/common/unzip', { params: parms })
}
