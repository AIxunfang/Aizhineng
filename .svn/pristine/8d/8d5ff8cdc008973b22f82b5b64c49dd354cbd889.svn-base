...
<el-container>
            <el-aside :width="adisewidth">
                <el-menu
                      ...
                      @select="selectmenu"
                     >
                  <div class="collapseicon"> <img src="../assets/img/logos.png" style="vertical-align:middle;width:28px;margin-left:10px;" />     <span  class="logoname"  v-show="this.isCollapse==false" >讯方AI学习计算平台</span></div>
    ...
    <el-container>
        ...
        <el-main>
            <!-- <keep-alive  include="progress-Bar">
                    <progress-Bar ></progress-Bar>
            </keep-alive> -->
          <div style="width:100%;height:20px ;position:fixed;z-index:99; float:right;" >
                       <keep-alive  include="progress-Bar">
                        <progress-Bar  :percentage='data.progress' :progressshow='data.progressshow' :noiceuser='data.noiceuser' ></progress-Bar>
                   </keep-alive>
            </div> 
                 <keep-alive>
