<template>
  <el-row class="wholeDrillRouce">
        <el-col :span="24">
         ...
         <el-col :span="24"  style="padding: 20px 20px 0px 20px;height:220px">
            <el-col :span="8">
         ...
         <el-col :span='24'  style="padding:10px 20px 0px 20px;">
              <el-col :span='8' style="text-align: center"> <span > CPU</span></el-col>
              <el-col :span='8' style="text-align: center"> <span > GPU</span></el-col>
              <el-col :span='8' style="text-align: center"> <span > 内存</span></el-col>
         </el-col>
