                  ...
                  <div  class="projectdiscrb">
                         ...
                         <div  class="projectdisright">
                            ...
                            <div class="projectdiecribetion"><span>模块描述:</span>{{item.trainingRemind}}</div>
                              <el-tooltip :content="item.projectNameZh" placement="top-start" effect="light">     
                   ...
                   <div class="projectbottom">
                         <div class="menukey">
                               <el-button  size="small"  icon="el-icon-download" v-if='item.trainingStatus==3||item.trainingStatus==4'  @click='doenmodel(index)'  >模型下载</el-button>
